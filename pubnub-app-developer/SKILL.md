...
1. Retrieve current SDK API from MCP/docs for the user's language. If MCP tools are not in this session, follow the MCP-absent rule above instead of inventing signatures.
